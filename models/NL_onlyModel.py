...
output_path = "/atlas/u/esheehan/wikipedia_project/dataset/poverty_dataset/output/comboModelSingleYearOut/"
...
def get_image_dataset(data):
    ...
    rgbn = np.asarray([np.load("/atlas/u/esheehan/wikipedia_project/dataset/GUF_dataset/data/" + i[7] + ".npy") for i in data])
